    ...
    <div class="modal-dialog" role="document" style="width: 452px;">
        ...
        <form id="formCapitulos" action="#">    
            <div class="modal-body">
                ...
                <label for="numeroCapitulo" class="col-form-label">Numero Capitulo</label>
                <input type="text" class="form-control" id="numeroCapitulo">
                </div>  

                <div class="form-group">
                <label for="tituloCapitulo" class="col-form-label">Nombre Capitulo:</label>
                <input type="text" class="form-control" id="tituloCapitulo">
                </div>  
